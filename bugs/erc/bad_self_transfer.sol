...
abstract contract ERC20 {
    ...
    function transfer(address to, uint256 amount) public virtual returns (bool) {
        ...
        // @bug accounting lead self transfer to increase the balance
        uint balance_in = balanceOf[msg.sender];
        uint balance_out = balanceOf[to];

        balance_in -= amount;
        balance_out += amount;

        balanceOf[msg.sender] = balance_in;
        balanceOf[to] = balance_out;
